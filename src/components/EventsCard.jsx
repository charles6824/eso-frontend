...
const EventsCard = () => {
  return (
    <div className='lg:w-[370px] lg:h-[475px] shadow-md font-[inter] rounded-md  '>
        ...
        <div className="bg-[#ADDF881A] p-4 ">
            <div className="flex items-center  justify-between relative">
                ...
                <button className="text-[#3CC13B] rounded-[4px] border-[#3CC13B] py-1 px-3 border absolute top-[-4px] left-[250px]">ongoing</button>
            </div>
            ...
            <div className="flex space-x-1 items-center ">
                <div className="flex items-center border py-[4px] px-[8px]">
                    <MdCalendarMonth className="text-[#316541]" />
                    <p className="text-[10px]">months</p>
                </div>
              
                <div className="flex items-center space-x-1 border py-[4px] px-[8px]">
            ...
            <div className="flex items-center justify-between p-3">
                <p className="text-[#316541]">Deadline: July 26, 2024</p>
