...
const About = () => {
  return (
    <section>
         ...
         <div className=' bg-[#ADDF881A] w-full  lg:p-[100px]  lg:px-20 py-8 md:py-0  '>
            <div className='justify-start px-8 lg:px-20' >
                <p className=' text-[13px]  md:text-[17px] leading-[13dpx] text-justify lg:leading-[30px] font-[500] mb-4 '>
            ...
            <div className=' w-full  text-[13px] font-[400] mb-[50px] mt-[100px] px-5  lg:px-32  '>
                <p className='text-[17px] mb-[11px] px-8 lg:px-0 '> Expert Solutions for Your Success</p>
                <p className='text-[#316541] text-[40px] px-8 lg:px-0  font-[600]'>Our Team</p>
